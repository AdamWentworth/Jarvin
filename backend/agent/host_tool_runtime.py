...
def manifest() -> dict[str, object]:
    ...
    return {
        ...
        "commands": [
            ...
            "/tool brief [morning|today|<location>]",
            "/tool reminder list",
            "/tool reminder add <task> <when>",
            "/tool reminder done <task>",
            ...
            "/tool calendar move <event name> | <new date/time>",
            "/tool calendar rename <event name> | <new title>",
            "/tool calendar location <event name> | <new location>",
            "/tool calendar clear-location <event name>",
            "/tool calendar notes <event name> | <new notes>",
            "/tool calendar clear-notes <event name>",
        ],
        "allowed_commands": [
            "rg ...",
            "pytest ...",
